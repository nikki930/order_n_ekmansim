...
N = 60 # the order up to which the model runs
...
if __name__ == "__main__":
    ...
    ek_rossby_vals = np.array([1.5, 1.75, 1.85])
    R_g = 0.1
    ...
    plt.title('Change in order of magnitude of $\psi_{correction}$')
    plt.legend()
