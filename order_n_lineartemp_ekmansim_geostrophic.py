"""
This is the version of the Ekman solver which excludes non geostrophic terms
"""
    ...
    def Jn(self, n_solve):
        ...
        if n_solve==0:
            ...
            for j in range(0, n+1):
                ...
                J2 += psi_x_arr[j, :] * np.mean(v_z_arr[n - j, :],axis=1).reshape((nx,1))/H - psi_z_arr[j, :] * np.mean(v_x_arr[n - j, :],axis=1).reshape((nx,1))/H
